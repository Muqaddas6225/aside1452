...
const NewsCard = (props) => {
  return (
    ...
    <div className='card-content'>
       <div className='img-div' ><img src={props.img}/></div>
        ...
        {/* style={{position:"absolute", top:"50%" ,left:'5%'}} */}
          <div className='news-body' >
              ...
              <Card.Text className='date-cmnt'>
                  <p className='date'><span><img src={date} /></span>{props.date}</p>
                  <p className='comment'><span><img src={cmnt} /></span>{props.comment}</p>
              </Card.Text>
