  ...
  return (
    <div className='YoutubeCard-div'>
      <Card className= {[(props.widthStyle === '39rem') ? "card1" : "card2" && (props.flex==='column') ? 'card3' : 'card4']} >
          <img src={props.img} alt='youtube' style={{width:"100%", height:'100%'}} />
          <Card.Body>
          <div className='youtubecard-body'>
              ...
              <Card.Text className='youtubecard-date-cmnt'>
                  <p className='youtubecard-date'><span><img src={date} alt='youtube' /></span>{props.date}</p>
                  <p className='youtubecard-comment'><span><img src={cmnt} alt='youtube' /></span>{props.comment}</p>
                  <p className='youtubecard-share'><span><img src={props.shareicon} alt='youtube'/></span>{props.share}</p>
              </Card.Text>
